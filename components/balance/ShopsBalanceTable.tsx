...
export function 
ShopsBalanceTable({ shopsBlances }: BalanceTableProps) {
    ...
    <Table>
      <TableHeader>
        <TableRow>
          ...
          {hasDetailedBalances && (
            <>
              <TableHead className="text-center">{labels.totalOwnerBalance}</TableHead>
              <TableHead className="text-center">{labels.totalRenterBalance}</TableHead>
            </>
          )}
