export const labels = {
  ...
  backToDate: "بازگشت",
  paidColumn: "پرداخت‌شده",
  paymentConflictTitle: "توجه: پرداخت‌ها جابه‌جا نمی‌شوند",
  paymentConflictNotice:
    "شارژ افراد مشخص‌شده کاهش می‌یابد، اما مبلغی که قبلاً در این دوره پرداخت کرده‌اند روی نام خودشان می‌ماند. برای اصلاح، پرداخت مربوطه را دستی به فرد جدید منتقل کنید.",

  renterBackdatedChargeWarning:
    "برای این دوره قبلاً شارژ صادر شده است و روی نام فرد قبلی باقی می‌ماند. در صورت نیاز، تاریخ تاریخچه را ویرایش کنید تا شارژ بازتقسیم شود.",
