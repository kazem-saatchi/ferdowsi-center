...
export const errorMSG = {
  ...
  duplicatePlaque: "شماره پلاک قبلاً وجود دارد.",
...
export const successMSG = {
  ...
  personIdFound: "شخص با موفقیت یافت شد.",
  ...
  shopIdFound: "فروشگاه با موفقیت یافت شد.",
  shopUpdated: "فروشگاه با موفقیت به‌روزرسانی شد.",

  shopHistoryAdded: "ورودی تاریخچه فروشگاه با موفقیت اضافه شد.",
  shopHistoryFound: "تاریخچه فروشگاه با موفقیت یافت شد.",

  chargesCreated: "هزینه با موفقیت ایجاد شد.",
  chargeCreated: "هزینه‌ای برای یک فروشگاه ایجاد شد.",
  chargesFound: "هزینه‌ها با موفقیت یافت شدند.",
