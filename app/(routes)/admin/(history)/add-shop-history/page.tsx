...
export default function AddShopHistoryPage() {
  ...
  const { data: personsData, isLoading: isLoadingPersons } =
    usePersonsByShop(selectedShopId);
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="deactivePeriod">
                    {labels.deactivePeriod}
                  </SelectItem>
          ...
          <CardFooter>
            <Button
              ...
              className="w-full"
              disabled={
                addShopHistoryMutation.isPending ||
                !selectedShopId ||
                !selectedPersonId
              }
            >
              {addShopHistoryMutation.isPending
                ? labels.addingHistory
                : labels.addShopHistory}
            </Button>
          </CardFooter>
        </form>
      </Card>
